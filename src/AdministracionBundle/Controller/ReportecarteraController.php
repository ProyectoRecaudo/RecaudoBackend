...
class ReportecarteraController extends Controller
{
    ...
    /*
    Esta funcion realiza una consulta de acuerdo al nombre del parametro cartera
    ...
    y si el valor del parametro cartera se envia false, se obtendra como resultado los filtros que debe tener ese reporte,
            ...
            if (!empty($request->get('authorization'))) {
                ...
                if ($authCheck) {
                    ...
                    if (in_array("PERM_REPORTES", $permisosDeserializados)) {
                        ...
                        $cartera = $request->get('reportecartera', null);
                        ...
                        if ($cartera == "false") {
                            ...
                            $data = array(
                                'status' => 'Exito',
                                'nombrereporte' => 'reportecartera',
                                'nombretabla' => 'reportecartera',
                                //'nombretabla' => 'trecibopuesto',
                                'numerofiltro' => '6',
                                'filtros' => $filtros_all,
                                'title' => $title,
                            );
